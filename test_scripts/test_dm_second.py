...
current_directory = f'/Users/giovanniminuto/Documents/My_codes/Cluster4/server_folder/test'
...
file_path_DM = os.path.join(current_directory, f"DM_der_second.csv")
