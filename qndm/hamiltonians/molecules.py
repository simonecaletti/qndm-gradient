...
def get_model_lithium(selected_key):
    ...
    new_url = "https://portal.nersc.gov/cfs/m888/dcamps/hamlib/chemistry/electronic/standard/LiH.zip"
...
def get_model_OH(selected_key):

    new_url = "https://portal.nersc.gov/cfs/m888/dcamps/hamlib/chemistry/electronic/standard/OH.zip"
...
# NOT E THE CHANGE INTO LINE 
#
# model["nqubit"] = 12 #get_nqubit(model["opfname"], selected_key)


def get_model_nitrogen(selected_key):

    new_url = "https://portal.nersc.gov/cfs/m888/dcamps/hamlib/chemistry/electronic/standard/BH.zip"
